...
def worker_fn(rank: int, world_size: int, args):
    ...
    for i in range(total_steps):
        ...
        unflat_grads = _unflatten_dense_tensors(flat_grads, grads_to_sync)

        for original_grad_data, new_grad_data in zip(grads_to_sync, unflat_grads):
            original_grad_data.copy_(new_grad_data)
